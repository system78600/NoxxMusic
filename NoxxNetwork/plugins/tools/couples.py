...
#BOT FILE NAME
from NoxxNetwork import app as app
from NoxxNetwork.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="|| ˹ɴᴏxx ɴᴇᴛᴡᴏʀᴋ˼ ||",
            url=f"https://t.me/NoxxNetwork",
        ),
    ],
]
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "NoxxNetwork/assets/upic.png"
         try:
         ...
         img = Image.open("NoxxNetwork/assets/cppic.png")
